...
Route::get('/generate_autopool/{round}', [App\Http\Controllers\Cron::class, 'index'])->name('generate_autopool');
...
Route::get('/manageMatching/{start}/{end}', [App\Http\Controllers\Cron::class, 'manageMatching'])->name('manageMatching');
...
Route::get('/cooki', [App\Http\Controllers\FrontController::class, 'cooki'])->name('cooki');
...
Route::post('/lastWithdrawal2', [App\Http\Controllers\UserPanel\Dashboard::class, 'lastWithdrawal2'])->name('user.lastWithdrawal2');
...
Route::get('/AddFundUSDT', [App\Http\Controllers\UserPanel\AddFund::class, 'AddFundUSDT'])->name('user.AddFundUSDT');
...
Route::get('/tree/{round}', [App\Http\Controllers\UserPanel\Team::class, 'tree'])->name('user.tree');
Route::any('/UsrBinaryReport',[App\Http\Controllers\UserPanel\BinaryReport::class,'userReport'])->name('UsrBinaryReport');

Route::get('/tree-view', [App\Http\Controllers\UserPanel\Team::class, 'genealogy2'])->name('user.tree-view');
...
Route::group(['middleware' => ['admin']], function ()
{
 ...
 Route::post('/change-return', [App\Http\Controllers\Admin\Dashboard::class, 'add_wallet'])->name('admin.change-return');
...
Route::get('user-activation', [App\Http\Controllers\Admin\UserController::class, 'user_activation'])->name('admin.user-activation');
 ...
 Route::get('roi_on', [App\Http\Controllers\Admin\UserController::class, 'roi_on'])->name('admin.roi_on');
 Route::get('withdrawal_on', [App\Http\Controllers\Admin\UserController::class, 'withdrawal_on'])->name('admin.withdrawal_on');
...
//fundController
 ...
 Route::get('transfer-fund', [App\Http\Controllers\Admin\FundController::class, 'transfer_fund'])->name('admin.transfer-fund');
 Route::post('SubmitFundTransfer', [App\Http\Controllers\Admin\FundController::class, 'SubmitFundTransfer'])->name('admin.SubmitFundTransfer');
 Route::post('debitFund', [App\Http\Controllers\Admin\FundController::class, 'debitFund'])->name('admin.debitFund');
 Route::get('debit-fund', [App\Http\Controllers\Admin\FundController::class, 'debit_fund'])->name('admin.debit-fund');
...
Route::get('bankPendingWithdrawal', [App\Http\Controllers\Admin\WithdrawController::class, 'bankPendingWithdrawal'])->name('admin.bankPendingWithdrawal');

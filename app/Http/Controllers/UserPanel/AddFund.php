...
public function AddFundUSDT(Request $request)
{
...
$user=Auth::user();
  ...
  $userInfo = auth()->user(); // or however you're getting the user info
    ...
    $queryParams = [
        'callback'      => 'https://beagers.com/dynamicupicallback?refid=' . $refId,
        'address'       => '0x05CE595b53295E51b4Ddd22aF68274f907E63904',
        'pending'       => 0,
        'confirmations' => 1,   
        'email'         => 'string',
        'post'          => 0,
        ...
        // ]);
                 $this->data['data'] =$data;
$this->data['page'] = 'user.fund.AddFundUSDT';
return $this->dashboard_layout();

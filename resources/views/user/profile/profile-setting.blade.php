                                            ...
                                            <div class="profile-bottom">
                                                <div class="profile-bottom__center">
                                                    ...
                                                    <div class="profile-bottom__btm">
                                                        ...
                                                        <span style="color: #A93E17">Member ID: <strong>{{($profile_data)?$profile_data->username:''}}</strong></span>
                                                        <span style="color: #A93E17">Registration Date: <strong><?php echo date("D, d M Y", strtotime(Auth::user()->jdate))?></strong></span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 col-xxl-4">
                                                    <div class="upc-content__in">
                                                        ...
                                                        <span>Email</span>
                                                        <p style="font-size: 11px;">{{($profile_data)?$profile_data->email:''}}
                                                        </p>
                                                    </div>
                                                </div>
                                                <!-- <div class="col-lg-12 col-xxl-4">
                                                    <div class="upc-content__in">
                                                        <span>Country</span>
                                                        <p>{{($profile_data->country)?$profile_data->country:'N/A'}}</p>
                                                    </div>
                                                </div> -->
                                                <div class="col-lg-12 col-xxl-4">
                                                    <div class="upc-content__in">
                                                        <span>Phone Number</span>
                                                        <p style="font-size: 11px;">{{($profile_data)?$profile_data->phone:''}}</p>
                                                    </div>
                                                </div>
                                                <div class="col-lg-12 col-xxl-4">
                                                    <div class="upc-content__in">
                                                        <span>Sponsor  Name</span>
                                                        <p style="font-size: 11px;"> {{($profile_data->sponsor_detail)?$profile_data->sponsor_detail->name:'0'}}</p>
                                                    </div>
                                                </div>
                                                <div class="col-lg-12 col-xxl-4">
                                                    <div class="upc-content__in">
                                                        <span>Sponsor ID</span>
                                                        <p style="font-size: 11px;">{{($profile_data->sponsor_detail)?$profile_data->sponsor_detail->username:'0'}}</p>
                                                    </div>
                                                </div>
                                                ...
                                                <form method="post" name="formmainprf" action="{{route('user.update-profile')}}">
                                                    ...
                                                    <div class="form-row">
                                                        <div class="form-group col-md-6 mb-3">
                                                            ...
                                                            <input type="text"   name="email" id="inputEmail" {{$profile_data->email?'readonly':''}}
                                                        ...
                                                        <div class="form-group col-md-6 mb-3">
                                                            ...
                                                            <input type="text" name="phone" id="inputEmail"
                                                                class="form-control control-edit" {{$profile_data->phone?'readonly':''}}
                                                    ...
                                                    <!-- <div class="form-row">
                                                     ...
                                                     <div class="text-center">
                                                                            <button type="submit"
                                                                                class="btn btn-primary support-btn" style="">Update
                                                                                 <span

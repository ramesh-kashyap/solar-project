                                                            ...
                                                            <div class="update">
                                                                ...
                                                                <div class="update-bdy">
                                                                    <div class="update-form">
	                                                                    ...
	                                                                    <div class="form-group">
                                                                            <label for="confloginpassword">UPI ID</label>
                                                                            <div class="input-group">

                                                                                <input class="form-control" type="text"
																				<?=(@$bank_value->upi_id)?"readonly":""?>
																				onkeyup="this.value=this.value.toUpperCase()" name="upi_id"
																				value="{{ @$bank_value->upi_id }}" placeholder="Enter UPI ID "
																				required>
                                                                            </div>
                                                                        </div>

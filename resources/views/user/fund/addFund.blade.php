                                                    ...
                                                    <ul>
                                                        <li>
                                                            <div class="cr-info-left">
                                                                <div>
                                                                     <i class="fa fa-rupee" style="    font-size: 36px;padding: 14px;padding-left: 16px; padding-bottom: 26px;"></i>
                                                                </div>
                                                            </div>
                                                                    ...
                                                                    <table class="table table-bordered">
                                                                        <thead>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <th > <br>
                                                                               UPI ID<br>
                                                                               <img src="{{asset('public/uploads/'.$general->qrcode1)}}" style="    width: 200px;">
                                                                               <br>
                                                                                 <span id="foo5">{{$general->upiId1}}</span>  <button
                                                                                    class="copy-btn" data-clipboard-target="#foo5"
                                                                                    style="border-radius: 0;"><i
                                                                                        class="bx bx-copy mr-0 1"></i></button>
                                                                             ...
                                                                             <tr>
                                                                                ...
                                                                                <th > 
                                                                              UPI ID <br>
                                                                             <img src="{{asset('public/uploads/'.$general->qrcode2)}}" style="    width: 200px;">
                                                                              <br>
                                                                              <span id="foo3">{{$general->upiId2}}</span> <button
                                                                                    class="copy-btn" data-clipboard-target="#foo3"
                                                                                    style="border-radius: 0;"><i
                                                                                        class="bx bx-copy mr-0 1"></i></button>
                                                                    ...
                                                                    <form action="{{ route('user.SubmitBuyFund') }}"
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-12 form-group">
                                                                                <input type="hidden" name="cointype"
                                                                                    id="wallet_type" value="PM">
                                                                                    <input type="text" class="form-control " name="transaction_hash" placeholder="UTR NO. " required="true">
                                                                            </div>

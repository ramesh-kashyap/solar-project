            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Debit Fund</a></li>
                    </ol>
                </div>
                <!-- row -->
                <div class="row">     
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="basic-form">
                                    <form action="{{ route('admin.debitFund') }}" method="POST">
                                     {{ csrf_field() }}
                                        <div class="row">
                                            ...
                                            <div class="mb-3 col-md-12">
                                                ...
                                                <input placeholder="Enter UserID" class="form-control check_sponsor_exist" type="text" data-response="sponsor_res" name="user_id"
                                                    value="" >

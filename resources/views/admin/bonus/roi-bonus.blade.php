            ...
            <div class="container-fluid">
				...
				<div class="row page-titles">
					<ol class="breadcrumb">
						...
						<li class="breadcrumb-item"><a href="javascript:void(0)">Auto Pool  Income</a></li>
					</ol>
                </div>
                <!-- row -->
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div id="example_wrapper" class="dataTables_wrapper">
                                    <form action="{{ route('admin.pool-bonus') }}" method="GET">
                                        <div class="row">
                                            <div class="col-xl-4">
                                            ...
                                            <div class="col-xl-2">
                                                <div class="form-group mb-3">
                                                    <a href="{{ route('admin.pool-bonus') }}" style="padding: 0.6rem 2rem;"
                                                        name="reset"
                                                        class="btn btn-outline-theme btn-lg d-block w-100 btn-primary"
                                                        value="Reset">Reset</a>
                                                </div>

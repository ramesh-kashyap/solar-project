...
<head>
    ...
    <!--end::Layout Themes-->
    <link rel="shortcut icon" href="{{asset('')}}assets/images/logoIcon/logo.png" />
                            ...
                            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover"
                                ...
                                <div class="menu-submenu dropdown-menu-wrap">
                                    ...
                                    <ul class="menu-subnav">
                                        ...
                                        <!-- <li class="menu-item menu-item-submenu" aria-haspopup="true"
                                            data-menu-toggle="hover">
                                            <a href="{{route('user.all-packages')}}" class="menu-link">
                                                <span class="menu-text">All Package Reports</span>
                                            </a>
                                        </li> -->
                            ...
                            <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover"
                                ...
                                <div class="menu-submenu dropdown-menu-wrap">
                                    ...
                                    <ul class="menu-subnav">
                                     ...
                                     <!-- <li class="menu-item menu-item-submenu" aria-haspopup="true"
                                        data-menu-toggle="hover">
                                        <a href="{{route('user.weeklyBonus')}}" class="menu-link">
                                                <span class="menu-text">Weekly Bonus</span>
                                            </a>
                                        </li>
                                        ...
                                        data-menu-toggle="hover">
                                        <a href="{{route('user.reward-bonus')}}" class="menu-link">
                                            <span class="menu-text">Monthly Royalty</span>
                                        </a>
                                    </li> -->

    ...
    margin-left: 17px;
        ...
        <div class="nav-header">
            <a href="{{asset('')}}" class="brand-logo">
                <img src="{{asset('')}}assets/images/logoIcon/logo.png" style="" alt=""/>
...
{{-- 
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                     ...
                     <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <!--<li><a href="{{ route('admin.debit-fund') }}">Debit Fund</a></li>-->
                            <!--<li><a href="{{ route('admin.transfer-fund') }}">Fund Transfer</a></li>-->
                    ...
                    <!-- <li><a href="{{route('admin.add-return')}}" class="ai-icon" aria-expanded="false">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ route('admin.pool-bonus') }}">Auto Pool Income</a></li>
                           
                            <li><a href="{{ route('admin.level-bonus') }}">Level Income</a></li>
                            <li><a href="{{ route('admin.rank-bonus') }}">Rank & Reward Income</a></li>
                            <!-- <li><a href="{{route('admin.reward-bonus')}}">Monty Royalty</a></li>
                            <li><a href="{{route('admin.special-direct-income')}}">Super Referral Income</a></li>
                            <li><a href="{{route('admin.weekly-bonus')}}">Weekly Bonus </a></li> -->

        ...
        <div class="container-fluid">
            <div class="ss-footer-sec">
                <div class="ss-footer-logosec">
                    ...
                    <p>In publishing and graphic design, lorem ipsum is placeholder text is from commonly used to
                        demonstrate.</p>
                    <h3>Contact Us</h3>
                    <div class="ss-call-box">
                        <img src="{{asset('')}}assets/images/call-icon.png" alt="icon">
                        <p>+91 99876 54321</p>
                    </div>
                    <div class="ss-call-box">
                        <img src="{{asset('')}}assets/images/mail-icon.png" alt="icon">
                        <p><a href="javascript:void(0);">yourmailid.com</a></p>
                    </div>
                </div>
                <div class="ss-footer-box">
                    ...
                    <ul class="ss-links">
                        ...
                        <li><a href="trade.html">About Us</a></li>
                ...
                <div class="ss-footer-box">
                    ...
                    <ul class="ss-links ss-social-links">
    ...
    <div class="ss-copyright-section">
        <p>Copyright © 2025 Solar Supplier. All Rights Reserved</p>
        <div class="ss-foooter-bottom">
            <img src="{{asset('')}}assets/images/footer-bottom.png" alt="image">
        </div>
    </div>
    ...
    <script src="{{asset('')}}assets/js/custom.js" type="javascript"></script>
    <script type="">
